...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-b from-[#0D1117] via-[#0c1929] to-[#0d2137] text-white py-12 border-t border-cyan-500/20">
      {/* Background Effects */}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold bg-gradient-to-r from-cyan-400 to-teal-600 bg-clip-text text-transparent drop-shadow-lg">
              Parthasarathy E
            </h3>
...
I build smart, scalable, and meaningful digital solutions that connect innovation with real-world impact. With a passion for technology and cloud systems, I turn data-driven ideas into smooth, efficient applications that work beautifully behind the scenes.            </p>
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="p-3 bg-slate-900/60 backdrop-blur-sm border border-slate-800/60 rounded-lg hover:bg-cyan-600/10 hover:border-cyan-500/40 transform hover:scale-110 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-600/20"
        ...
        <div className="border-t border-slate-800/50 mt-12 pt-8 text-center">
          <p className="text-gray-300 flex items-center justify-center gap-2">
            Made with <Heart size={16} className="text-cyan-500" /> by Parthasarathy © {new Date().getFullYear()}
          </p>
        </div>
      </div>
    </footer>
