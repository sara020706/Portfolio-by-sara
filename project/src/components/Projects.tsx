...
const Projects: React.FC = () => {
  ...
  return (
    <section id="projects" className="py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-purple-900 relative">
      {/* Background Effects */}
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-40 left-40 w-96 h-96 bg-gradient-to-tr from-blue-500/20 to-cyan-500/20 rounded-full blur-3xl"></div>
      </div>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="relative overflow-hidden">
                ...
                />
                <div className={`absolute inset-0 bg-gradient-to-t ${project.color} opacity-60 group-hover:opacity-70 transition-opacity duration-300`}></div>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tags.map((tag) => (
                    <span 
                      key={tag}
                      className="px-3 py-1 bg-slate-700/50 border border-slate-600/50 text-cyan-300 rounded-full text-sm font-medium hover:bg-cyan-500/20 hover:border-cyan-400/50 transition-all duration-200"
                    >
                      {tag}
                    </span>
                  ))}
